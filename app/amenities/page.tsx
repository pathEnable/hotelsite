            ...
            <div className="max-w-7xl mx-auto px-6 py-24 space-y-14">
                ...
                <Reveal>
                    <section className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <Card className="order-2 md:order-1 bg-surface/60">
                            <CardHeader>
                        ...
                        <div className="order-1 md:order-2 relative h-[400px] bg-surface rounded-lg overflow-hidden border border-border">
                            <Image
